...
[params,residual]=fitCoreRepeatModelInfiniteTestingCon(koffData,KDData,weights,seqIdentifier,regionsAdded,paramIndex,numGuesses,lb,ub,koffmicrofac,prelfac);
[params2,residual2]=fitCoreRepeatModelInfiniteTestingCon(koffData,KDData,weights,seqIdentifier,regionsAdded,paramIndex,numGuesses,lb,ub,koffmicrofac,prelfac); % Run agian to see if same minima is found
