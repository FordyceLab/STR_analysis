function [KD,koff] = getRatesCoreRepeatFastConvertParamsFromKD(params,solutionConc)
%getRatesCoreRepeat gets equllibrium KD and effeictice rates koff and kon,
%for the  4 state model described by params
%input params=[%konmax %koff,M KDmicro_core KDmicro_flank p_core_rel p_flank_rel]
...
koffmicro_core=params(3)*params(2)*params(5);
koffmicro_flank=params(4)*params(2)*params(6);
