function [rates,boundFracOn,boundFracOff] = modelRatesVecTimesODEsFast(kaMax,kOffMicroDeep,pvals,invTimes,dissocConc,assocConc,dissocMeasTimes,assocMeasTimes,retslope,analytic)
...
%        expMatr=Voff*diag(exp(diag(Doff*dissocMeasTimes(i))))/Voff;%
        expMatr=expm2(rateMatrAoff*dissocMeasTimes(i));
