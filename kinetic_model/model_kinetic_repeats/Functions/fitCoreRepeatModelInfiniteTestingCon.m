function [bestParams,bestResidual,paramsAll,resAll] = fitCoreRepeatModelInfiniteTestingCon(koffData,KDData,weights,seqIdentifier,regionsAdded,paramIndex,numGuesses,lb,ub,koffmicrofac,prelfac)
