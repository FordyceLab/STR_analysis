function [onMeanFirstPassage,offMeanFirstPassageInitial] = getPassagetimeTotalInfiniteTesting(params,solutionConc)
...
%params = [konmax koffmicro_core koffmicro_flank p_core p_flank]
...
% end
     ...
     onMeanFirstPassage=((1/(params(1)*solutionConc)))/(p_core+p_flank);
