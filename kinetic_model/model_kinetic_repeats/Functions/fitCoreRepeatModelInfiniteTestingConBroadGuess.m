function [bestParams,bestResidual,paramsAll,resAll] = fitCoreRepeatModelInfiniteTestingConBroadGuess(koffData,KDData,weights,seqIdentifier,regionsAdded,paramIndex,numGuesses,lb,ub,koffmicrofac,prelfac)
...
guessMin(paramIndex(1):paramIndexEnd(1))=10^-8; %koffmicro_core
guessMin(paramIndex(2):paramIndexEnd(2))=10^-8; %koffmico_flank 
guessMin(paramIndex(3):paramIndexEnd(3))=10^-8; %p_core_rel 
guessMin(paramIndex(4):paramIndexEnd(4))=10^-8; %p_flank_rel


guessMax(1)=10^3; %konmax
guessMax(paramIndex(1):paramIndexEnd(1))=10^8; %koffmicro_core
guessMax(paramIndex(2):paramIndexEnd(2))=10^8; %koff_micro_flank
guessMax(paramIndex(3):paramIndexEnd(3))=10^8; %p_core_rel 
guessMax(paramIndex(4):paramIndexEnd(4))=10^8; %p_flank_rel
