...
for i=1:numInData
   if ismember(seqIdentifier(i,2),flanksToTrainOn)&&seqIdentifier(i,1)==1
       weights(i)=1;
   end
end
...
[params,residual]=fitCoreRepeatModelKDmicro(koffData,KDData,weights,seqIdentifier,regionsAdded,paramIndex,numGuesses,lb,ub);

[KDModel,koffModel] = getManyCoreRepeatModelKDmicro(params,weightsAll,seqIdentifier,paramIndex);
