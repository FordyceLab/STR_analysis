...
for i=1:numReps
    ...
    for j=1:numFits
        ...
        [paramsCurr,residualCurr,paramsAllCurr,residualAllCurr]=fitCoreRepeatModelInfiniteTestingConBroadGuess(koffData,KDData,weights,seqIdentifier,regionsAdded,paramIndex,numGuesses,lb,ub,koffmicrofac,prelfac);
