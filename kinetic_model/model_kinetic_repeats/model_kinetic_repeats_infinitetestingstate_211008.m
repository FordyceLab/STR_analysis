...
for i=1:numReps
    ...
    for j=1:numFits
        ...
        [paramsCurr,residualCurr,paramsAllCurr,residualAllCurr]=fitCoreRepeatModelInfiniteTesting(koffData,KDData,weights,seqIdentifier,regionsAdded,paramIndex,numGuesses,lb,ub);
